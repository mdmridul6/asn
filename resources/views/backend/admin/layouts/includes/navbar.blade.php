<!--begin::Header-->
<div class="header align-items-stretch" id="kt_header" style="">
    <!--begin::Container-->
    <div class="container-fluid d-flex align-items-stretch justify-content-between">
        ...
        <div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0">
            <a class="d-lg-none" href="#">
                <img class="h-30px" src="{{ asset('backend/assets/media/logos/logo-3.svg') }}" alt="Logo" />
            </a>
        </div>
        <!--end::Mobile logo-->
        <!--begin::Wrapper-->
                ...
                <div class="d-flex align-items-center ms-1 ms-lg-3">
                    ...
                    <div class="btn btn-icon btn-active-light-primary position-relative w-30px h-30px w-md-40px h-md-40px"
                        ...
                        <span class="svg-icon svg-icon-1">
                            <img src="{{ asset('backend/assets/media/icons/duotone/Code/Compiling.svg') }}"
                                alt="">
                        </span>
                        <!--end::Svg Icon-->
                    </div>
                    ...
                    <div class="menu menu-sub menu-sub-dropdown menu-column w-350px w-lg-375px" data-kt-menu="true">
                        ...
                        <div class="d-flex flex-column bgi-no-repeat rounded-top">
                            ...
                            <h3 class=" text-dark fw-bold px-9 mt-10 mb-6">Notifications
                                <span
                                    class="badge badge-primary fs-8">{{ auth()->user()->notifications->count() }}</span>
                            </h3>
                            <!--end::Title-->
                        </div>
                        <!--end::Heading-->
                            ...
                            <div class="tab-pane fade show active" id="kt_topbar_notifications_1" role="tabpanel">
                                    ...
                                    @forelse (auth()->user()->notifications as $notifications)
                                        ...
                                        <div class="d-flex flex-stack py-4">
                                            ...
                                            <div class="d-flex align-items-center">
                                                ...
                                                <!--begin::Title-->
                                                <div class="mb-0 me-2">
                                                    <a class="fs-7 text-gray-400 " href="#">Deacivate</a>
                                ...
                                <div class="py-3 text-center border-top">
                                    <a class="btn btn-color-gray-600 btn-active-color-primary"
                                        href="pages/profile/activity.html">View
                                        All
                    ...
                    <div class="d-flex align-items-center ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
                        ...
                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-primary fw-bold py-4 fs-6 w-300px"
                            ...
                            <div class="menu-item px-5">
                                <a class="menu-link px-5" href="{{ route('admin.profile.index') }}">My Profile</a>
                            </div>
                            <!--end::Menu item-->

                            <!--begin::Menu item-->
                            <div class="menu-item px-5 my-1">
                                <a class="menu-link px-5" href="{{ route('admin.setting.index') }}">Settings</a>
                            </div>
                            <!--end::Menu item-->
                            <!--begin::Menu item-->
                            <div class="menu-item px-5">
